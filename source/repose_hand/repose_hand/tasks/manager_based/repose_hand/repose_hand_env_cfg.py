...
@configclass
class ReposeHandSceneCfg(InteractiveSceneCfg):
...
@configclass
class ReposeHandEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: ReposeHandSceneCfg = ReposeHandSceneCfg(num_envs=8192, env_spacing=0.6)
    # Simulation settings
...
@configclass
class ReposeHandEnvCfg_PLAY(ReposeHandEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class ReposeHandNoVelObsEnvCfg(ReposeHandEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class ReposeHandNoVelObsEnvCfg_PLAY(ReposeHandNoVelObsEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a smaller scene for play
